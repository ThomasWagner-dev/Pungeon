public class Door extends WorldObj implements Collider{
    ...
    public static void close(DungeonWorld world) {
        ...
        world.addObject(new Door(), DungeonWorld.pixelSize*11-DungeonWorld.pixelSize/2, DungeonWorld.pixelSize*DungeonWorld.width-DungeonWorld.pixelSize/2);
        world.addObject(new Door(), DungeonWorld.pixelSize*12-DungeonWorld.pixelSize/2, DungeonWorld.pixelSize*DungeonWorld.width-DungeonWorld.pixelSize/2);
    }
}
